...
import { AdminPixelManagerForm } from "@/components/admin/features/AdminPixelManagerForm";
...
export default function AdminPixelsPage() {
  ...
  return (
    <AdminPanelShell
      locale={locale}
      title={getAdminText(locale, "pixels.title")}
      description={getAdminText(locale, "pixels.description")}
    >
      <AdminPixelManagerForm />
    </AdminPanelShell>
  );
}
